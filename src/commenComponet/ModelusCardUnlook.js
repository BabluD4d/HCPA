            ...
            <Box className="sedow" sx={{backgroundColor:"#E4EFFA", borderRadius:'5px'}} p={2}>
                <Grid container >
                    ...
                    <div style={{display:"initial"}}>
                        <Typography onClick={()=>{localStorage.setItem("UserModule",JSON.stringify(props.Module));setTimeout(() => {Navigate("/Modules/Document") }, 300); }} mt={4}  sx={{ color: "#0CB4D0", fontSize: "15px",cursor:"pointer" }}  >
...
export default ModulesCardUnlook
