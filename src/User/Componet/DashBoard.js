            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={4}xl={3} sm={4} lg={3}>
                    <div style={{ display: "flex" }}>
                        <Typography mt={5} ml={6} sx={{ fontSize: "20px",cursor:"pointer" }} >Files </Typography>
                        <Typography mt={6} ml={1} sx={{ color: "#0CB4D0;", fontSize: "14px",cursor:"pointer" }}>  View All Files</Typography>
                    </div>
